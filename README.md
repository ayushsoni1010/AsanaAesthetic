...
**1.** Fork [this](https://github.com/ayushsoni1010/AsanaAesthetic) repository.

**2.** Clone your forked copy of the project.

```
git clone --depth 1 https://github.com/ayushsoni1010/AsanaAesthetic.git
```
...
```
git remote add upstream https://github.com/ayushsoni1010/AsanaAesthetic.git
```
...
**15.** Hurray ❗ You have created a PR to the Asana Aesthetic 💥 . Sit back patiently and relax till then the project maintainers will review your PR. Please understand, there will be some time taken to review a PR and can vary from a few hours to a few days too so be Patient and keep contributing.

## 📝 License

This project follows the [MIT License](https://github.com/ayushsoni1010/AsanaAesthetic/blob/main/LICENSE)
